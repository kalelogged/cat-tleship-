...
public class KeyBox extends Canvas implements KeyListener,Runnable ,MouseListener, MouseMotionListener
{
	...
	public void paint( Graphics window )
	{
		...
		Image start = Toolkit.getDefaultToolkit().getImage("cattleshipTitle.png");
	...
	public void keyReleased(KeyEvent e)
	{
		if(e.getKeyCode() == KeyEvent.VK_SPACE) {
			...
			jf3.add(new JLabel(new ImageIcon("bigGrid.png")));
			jf3.show();
			...
			jf2.add(new JLabel(new ImageIcon("instructions.png")));
			jf2.show();
